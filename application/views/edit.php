...
<head>
    ...
    <title>CRUD Application in Codeigniter - Update User</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-md-12 frm shadow p-5 ">
            ...
            <form method="POST"   action="<?php echo base_url().'index.php/user_crud/edit/'.$user_edit['user_id']; ?>" name="createuser">
                <h1 class="text-center text-primary font-weight-light mb-3">Update User</h1> 
                <!-- <hr class="bg-primary"> -->
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="colblu">Name</label> 
                        <input type="text" class="form-control " id="name" placeholder="Enter Name" name="name" value="<?php echo set_value('name', $user_edit['name']);?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="Enter Email" name="email" value="<?php echo set_value('email', $user_edit['email']);?>">
                         <small class="coled" ><?php echo form_error('email'); ?></small>
                    </div>
                    <div class="text-center pt-3">
                        <button type="submit" class="btn btn-outline-primary shadow w-25">Update</button>
